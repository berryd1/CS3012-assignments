...
public class DAG {
	...
	public DAG(int V) {
		if (V < 0)
			throw new IllegalArgumentException("Cannot have non-negative number of vertices in a digraph");
		this.V = V;
		this.E = 0;
		indegree = new int[V];
	...
	public int findLowestCommonAncestor(int v, int w) {
		...
		// cycle through the BFS paths, adding all common ancestors to the
		// arrayList
